/**
 * File contains a class named HolbertonCourse
 */

export default class HolbertonCourse {
  /**
   * Defines the class @see {@link HolbertonCourse}
   * @param {String} name - Represents the name of the course
   * @param {Number} length - The duration of the course
   * @param {String[]} students - The student's names
   */
